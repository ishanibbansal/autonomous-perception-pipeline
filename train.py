...
def train_model(args):
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for batch_idx, batch in enumerate(train_dataloader):
            ...
            targets = encoded_targets['bev_occupancy'].to(device)
